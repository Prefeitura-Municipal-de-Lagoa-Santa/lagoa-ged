...
const breadcrumbs:BreadcrumbItem[] = [
    ...
    { title: 'Permissões' }, 
    { title: 'Grupos', href: route('permissions.groups') } 
];
            ...
            <div class="bg-card p-0 sm:p-6 rounded-lg shadow-md overflow-x-auto">
                <table class="min-w-full divide-y divide-border">
                    <thead class="bg-muted/50">
                        <tr>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Nome do Grupo</th>
                    ...
                    <tbody class="bg-card divide-y divide-border">
                        ...
                        <tr v-for="g in props.groups.data" :key="g.id" class="hover:bg-muted/50 transition-colors">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-foreground">{{ g.name }}</td>
