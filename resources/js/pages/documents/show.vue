        ...
        <div class="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-stone-950/95 p-8 rounded-2xl shadow-xl mb-10 border border-gray-200 dark:border-stone-800">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-4 gap-2">
                    ...
                    <!-- Botão Ver detalhes apenas em telas médias e grandes -->
                    <button 
                ...
                <!-- Conteúdo expansível dos metadados para telas médias e grandes -->
                <Transition
                    name="expand"
                ...
                <!-- Metadados sempre visíveis em telas pequenas -->
